...
If `long-ident` from [§](patterns.md#named-patterns) resolves to a union case, [the pattern is a union case pattern](/spec/draft/discriminated-union-representation.md). If `long-ident`
