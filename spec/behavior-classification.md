...
- **The platform facts the predicate mechanism reads** ([Platform Predicates](platform-predicates.md)) — endianness, word width, the presence of a hardware feature — are implementation-defined and resolved through the platform-quotation mechanism rather than hard-coded in source.
